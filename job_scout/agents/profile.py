...
from job_scout.parsers.resume import extract_resume_text
from job_scout.schemas import CandidateProfile
from job_scout.schemas.common import SeniorityLevel
